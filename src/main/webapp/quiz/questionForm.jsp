...
<div class="container mt-5">
    <div class="card">
        ...
        <div class="card-body">
            <form:form method="post" action="${pageContext.request.contextPath}/quiz/submitQuestions" modelAttribute="quizForm">
                ...
                <div class="text-center">
                    <input type="submit" value="질문 제출" class="btn btn-primary"/>
                </div>
            </form:form>
        </div>
    </div>
